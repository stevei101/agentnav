...
class VisualizerAgent(Agent):
    ...
    def __init__(
        self, a2a_protocol, gemma_service_url: Optional[str] = None, event_emitter=None
    ):
    ...
    async def process(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if self._linked_data:
                ...
                self.logger.info(
                    "⚙️ Fallback: Generating visualization directly with Gemma"
                )
                result = await self._create_visualization_with_gemma(
    ...
    async def _create_visualization_with_gemma(
        ...
        try:
            ...
            try:
                ...
                if json_match:
                    ...
                    logger.warning(
                        "Could not parse JSON from Gemma response, using fallback"
                    )
