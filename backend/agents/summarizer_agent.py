...
"""
    ...
    async def _generate_summary(self, document: str, content_type: str) -> str:
        ...
        try:
            ...
            prompt = prompt_template.format(
                content=document[:4000],  # Limit content for prompt size
                content_type=content_type
            )
    ...
    def _extract_insights(self, document: str, content_type: str, summary: str) -> Dict[str, Any]:
        ...
        insights["compression_ratio"] = round(insights["summary_length"] / insights["word_count"], 3)
    ...
    async def _notify_summary_complete(self, summary: str, insights: Dict[str, Any]):
        ...
        message = A2AMessage(
            ...
            data={
                "summary": summary[:200] + "..." if len(summary) > 200 else summary,  # Truncated for message
                "insights": insights,
