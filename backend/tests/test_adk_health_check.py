...
class TestHealthzEndpoint:
    ...
    def test_healthz_with_operational_adk(self):
        ...
        with patch('main.OrchestratorAgent') as mock_agent_class, \
    ...
    def test_healthz_firestore_error_handling(self):
        ...
        with patch('main.get_firestore_client', side_effect=Exception("Firestore connection failed")):
            response = client.get("/healthz")
...
class TestAgentStatusEndpoint:
    ...
    def test_agent_status_operational(self):
        ...
        with patch('main.OrchestratorAgent') as mock_orch, \
    ...
    def test_agent_status_includes_environment_vars(self):
        ...
        with patch('main.OrchestratorAgent'), \
