...
def get_gemini_client(model_name: str = "gemini-1.5-flash"):
    ...
    try:
        ...
        if gcp_project:
            ...
            logger.info(
                f"🔐 Using Application Default Credentials (Workload Identity) for GCP project: {gcp_project}"
            )
    ...
    **kwargs,
    ...
    try:
        ...
        response = await loop.run_in_executor(
            None, lambda: client.generate_content(full_prompt, generation_config=generation_config)
        )
