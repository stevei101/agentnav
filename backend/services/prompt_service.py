...
class PromptService:
    ...
    def create_prompt(self, prompt_data: dict, user_id: str, user_name: str) -> Prompt:
        """Create a new prompt"""
    ...
    def update_prompt(
        self, prompt_id: str, updates: dict, user_id: str, user_name: str
    ) -> Optional[Prompt]:
    ...
    def delete_prompt(self, prompt_id: str) -> bool:
        ...
        versions_query = self.db.collection(self.versions_collection).where(
            "promptId", "==", prompt_id
        )
    ...
    def get_versions(self, prompt_id: str) -> List[PromptVersion]:
        ...
        query = (
            self.db.collection(self.versions_collection)
    ...
    def add_test_result(
        self, prompt_id: str, test_data: dict, user_id: str, user_name: str
    ) -> Optional[Prompt]:
    ...
    def _save_version(
        self, prompt_id: str, prompt: Prompt, user_id: str, user_name: str, version: int
    ):
        ...
        self.db.collection(self.versions_collection).document(version_id).set(
            version_data.dict()
        )
