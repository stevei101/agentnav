    ...
    async def send_message(self, message: A2AMessageBase):
        ...
        try:
            ...
            if not validation_result["is_valid"]:
                logger.error(f"❌ Message security validation failed: {validation_result['issues']}")
    ...
    def _log_message_event(
        ...
        log_entry = {
            ...
            "trace_context": {
                ...
                "parent_message_id": message.trace.parent_message_id if hasattr(message, 'trace') else None,
            },
            "security_context": {
                "service_account_id": message.security.service_account_id if hasattr(message, 'security') else None,
